  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="views/_icerik.php">İçerik</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="createBlog.php">Blog Ekle</a></li>
            <li><a class="dropdown-item" href="editBlog.php">Blog Düzenle</a></li>
